...
> **Difficulty:** 12
> **Potential Adversaries:** Zombies (Brawny Zombie, Patchwork Zombie Hulk, Rotted Zombie, Shambling Zombie, Zombie Pack)

## Environment Features

### Arcane Engine - Passive
...
### The Last Car - Reaction

The source of the corruption lies at the rear of the train. As the PCs approach, low moans echo from within. The door trembles slightly, as if something inside is pressing against it. When the car is opened, unleash the swarm:

- Spawn 1 Rotted Zombie
- Spawn 1 Patchwork Zombie Hulk
- Spawn 1d6 Zombie Packs

### Spreading Sickness - Reaction
...
### The Source of the Infection - Passive
...
*Screams echo through narrow corridors as something spreads from carriage to carriage. Behind you, the dead are rising. Ahead, the engine carries you deeper into the unknown. There is no safe place left on board, only time, running out with every passing moment.*

> **Design notes:** This was my first attempt of a Environment. The trope of "something evil is within the train" is a classic and I needed to try it. It works, my players love it.
