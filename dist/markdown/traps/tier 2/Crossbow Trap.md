...
**Trigger:** When a target steps on the hidden wire.

**Effect:** Targets in a line from the trap to Very Far range must make an Agility Reaction Roll. On a failure, they mark 1 HP. On a success, they avoid the shot.

### Disarm

**Trigger:** When a PC identifies the trap.
